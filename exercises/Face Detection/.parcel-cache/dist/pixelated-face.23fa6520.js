...
})({"b876ae4c136095e48a31cf9e6377095a":[function(require,module,exports) {
...
optionsInput.forEach(input => input.addEventListener("input", handleOption)); //This function is declared as async so as to use the await keyword
...
function censor({
  ...
  face.y, options.SIZE, options.SIZE); // draw the small face we drew using the 4 draw args, back to normal size to create pixelation

  const width = face.width * options.SCALE;
  const height = face.height * options.SCALE;
  faceCtx.drawImage( //source args -5
  faceCanvas, face.x, face.y, options.SIZE, options.SIZE, // draw args -4
...
},{}]},{},["13ce80ed9a2051f997528b96cdd8e3d2","b876ae4c136095e48a31cf9e6377095a"], null)

//# sourceMappingURL=pixelated-face.23fa6520.js.map
