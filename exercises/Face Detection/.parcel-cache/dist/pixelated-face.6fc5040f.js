...
const SIZE = 10;
const SCALE = 1.35; //This function is declared as async so as to use the await keyword
...
function censor({
  ...
  face.y, SIZE, SIZE); // draw the small face we drew using the 4 draw args, back to normal size to create pixelation

  const width = face.width * SCALE;
  const height = face.height * SCALE;
  faceCtx.drawImage( //source args -5
  faceCanvas, face.x, face.y, SIZE, SIZE, // draw args -4
...
//# sourceMappingURL=pixelated-face.6fc5040f.js.map
